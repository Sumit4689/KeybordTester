                ...
                <div className="keyboardCasing rounded-lg shadow-lg p-6">
                    <div className="keyboard-container bg-[var(--card-background)] rounded-lg p-6">
                        <div className="function-key">
                            ...
                            <div className="key-cluster">
                                <div className="key function-row"><div className="keycap"><span className="bottom">F5</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F6</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F7</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F8</span></div></div>
                            </div>
                            <div className="key-cluster">
                                <div className="key function-row"><div className="keycap"><span className="bottom">F9</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F10</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F11</span></div></div>
                                <div className="key function-row"><div className="keycap"><span className="bottom">F12</span></div></div>
                            </div>
                            <div className="singlekey">
                        ...
                        <div className="keyboard-row">
                            ...
                            <div className="qwerty-third">
                                <div className="qwerty-third-left">
                                    <div className="key key-shift-Left"><div className="keycap"><span className="bottom">Shift</span></div></div>
                                    ...
                                    <div className="key"><div className="keycap"><span className="top">&gt;</span><span className="bottom">.</span></div></div>
                                    <div className="key"><div className="keycap"><span className="top">?</span><span className="bottom">/</span></div></div>
                                    <div className="key key-shift-Right"><div className="keycap"><span className="bottom">Shift</span></div></div>
                                </div>
